const projects = [
	...
	{
		title: `AI Trader`,
		description: `A trade bot that buys and sells stocks based on indicators like moving average and open/close price. Backend Stack: Python, Alpaca, AWS DynamoDB, FastAPI, AWS Elastic Beanstalk, Firstrade API, AlphaVantage API. Frontend Stack: Typescript, React, NextJs, AWS Amplify`,
		...
		image: "./images/aitrader.png",
		alt: "ai trader",
		githubLinks: [
			"https://github.com/andrewcbuensalida/auto-trader-ui.git",
			"https://github.com/andrewcbuensalida/EtradePythonClient.git",
		],
	},
	{
