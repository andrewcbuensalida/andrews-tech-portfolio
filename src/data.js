...
const projects = [
	...
	},
	{
		...
		description: `Create, Read, and Delete blogs. Stack includes MongoDB, mvc, Google Cloud Platform's App Engine and Cloud Build for CI/CD, Node, Express rate limiting, and ejs for the front-end.`,
